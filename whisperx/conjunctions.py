...
conjunctions_by_language = {
    ...
    'sv': {'därav', 'därefter', 'därmed', 'därtill', 'dels', 'dessutom', 'dock', 'då', 'efter', 'fastän', 'först', 'förutom', 'innan', 'medan', 'men', 'när', 'och', 'relativt', 'senare', 'sist', 'såsom', 'tillika', 'trots', 'tvärtemot', 'utöver', 'varpå', 'ytterligare', 'ändå'}
